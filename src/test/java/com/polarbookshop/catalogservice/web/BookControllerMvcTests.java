...
import static com.polarbookshop.catalogservice.domain.Book.of;
...
class BookControllerMvcTests {
    ...
    void whenGetBookExistingAndAuthenticatedThenShouldReturn200() throws Exception {
        var isbn = "7373731394";
        var expectedBook = of(isbn, "Title", "Author", 9.90, "Polarsophia");
    ...
    void whenPostBookWithEmployeeRoleThenShouldReturn201() throws Exception {
        var isbn = "7373731394";
        var bookToCreate = of(isbn, "Title", "Author", 9.90, "Polarsophia");
